...
precip_df = pd.read_csv('precip_pixels_'+county+'.csv',  nrows = 100)
ndvi_res  = pd.read_csv('NDVI_residuals_'+county+'.csv', nrows = 100) 
ndvi_results = pd.read_csv('ndvi_results_'+county+'.csv',index_col=0, nrows = 100)

#pick a row to plot
row = ndvi_results.index[33]
